...
read -p "${GREEN_TEXT}${BOLD_TEXT}Enter the USER_2: ${RESET_FORMAT}" USER_2
export USER_2
echo "${YELLOW_TEXT}${BOLD_TEXT}USER_2 set to: ${USER_2}${RESET_FORMAT}"

read -p "${GREEN_TEXT}${BOLD_TEXT}Enter the ZONE: ${RESET_FORMAT}" ZONE
export ZONE
echo "${YELLOW_TEXT}${BOLD_TEXT}ZONE set to: ${ZONE}${RESET_FORMAT}"

read -p "${GREEN_TEXT}${BOLD_TEXT}Enter the TOPIC: ${RESET_FORMAT}" TOPIC
export TOPIC
echo "${YELLOW_TEXT}${BOLD_TEXT}TOPIC set to: ${TOPIC}${RESET_FORMAT}"

read -p "${GREEN_TEXT}${BOLD_TEXT}Enter the FUNCTION: ${RESET_FORMAT}" FUNCTION
export FUNCTION
echo "${YELLOW_TEXT}${BOLD_TEXT}FUNCTION set to: ${FUNCTION}${RESET_FORMAT}"
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Subscribe my Channel (QwikLab Explorers):${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@qwiklabexplorers${RESET_FORMAT}"
